...
("7","11","there are identical, fraternal, half-identical,mirror image, mixed, chromosome, and superfecundation, and superfetation .",
...
("50-60","70-80","75 burgers are sold in McDonald’s every second.","how match Mcburgers are sold in seconds?"),
("False","True","False. You can’t hum while holding your nose.","True or False: You can hum while holding your nose?"),
("True","False","True. Your eyeballs do not grow or change their size as you age.","True or False: your eyeballs grow over the yers?"),
...
("No","Yes","Pigs can’t look up into the sky.","Pigs can see the sky?"),
